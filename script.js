...
function createWrapper(img) {
  ...
  imageWrapper.className = "kaalaa_product_image_wrapper";

  const Icon = new Image();
  Icon.className = "kaalaa_product_image";
  Icon.src = "https://cdn-icons-png.flaticon.com/512/833/833655.png";

  let timerWrapper = document.createElement("div");
  timerWrapper.className = "kaalaa_timer_container";
  ...
  productName.innerText = "kaalaa_Product name";
  productName.className = "kaalaa_product_name";

  let productDesc = document.createElement("p");
  productDesc.innerText = "Descrition of the prodcut";
  productDesc.className = "kaalaa_product_desc";

  let button = document.createElement("button");
  button.innerText = "BUY FOR $1";
  button.className = "kaalaa_product_button";
        ...
        if (timer) {
          if (images[existImages].timer === 0) {
            ...
            if (!timer.dataset.reward) {
              ...
              setTimeout(() => {
                timer.style.width = claimed ? "min-content" : "100px";
...
async function generateQRCode(data) {
  ...
  const container = document.querySelector("#kaalaa_QRContainer");
...
async function createDownload() {
  ...
  downloadlink.className = "kaalaa_modal-button";
  downloadlink.innerText = "Download App";

  const downloadlink2 = document.createElement("button");
  downloadlink2.className = "kaalaa_modal-button";
...
function modalDisplay() {
  ...
  modalContainer.className = "kaalaa_modal";
  modalContainer.id = "kaalaa_claim_modal";
  modalContainer.style.display = "flex";

  const modalContentWrapper = document.createElement("div");
  modalContentWrapper.className = "kaalaa_modal-content";
  ...
  closeRewardIcon.className = "kaalaa_modal-close";
  ...
  modalStatusWrapper.className = "kaalaa_modal-status-container";
